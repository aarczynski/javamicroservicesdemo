INSERT INTO candidate (id, first_name, last_name, email, geo_lat, geo_lon, radius_km, years_of_experience, expected_salary, created_at, updated_at)
VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Jan',  'Kowalski',  'jan.kowalski@example.com',       52.2297, 21.0122, 100.0,  8, 20000.00, NOW(), NOW()),
       (gen_random_uuid(),                       'Anna', 'Nowak',     'anna.nowak@example.com',         50.0647, 19.9450,  50.0,  3, 18000.00, NOW(), NOW()),
       (gen_random_uuid(),                       'Piotr','Wiśniewski','piotr.wisniewski@example.com',   52.2297, 21.0122, 200.0, 12, 25000.00, NOW(), NOW());
