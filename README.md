...
```shell
java -jar data-generator/build/libs/data-generator-1.0.0.jar 200000 100000 20000
```

This generates SQL scripts that insert companies, skills (52 predefined technology names), job offers with their required skills and employment types, and candidates with their preferred skills and employment types.
