...
INSERT INTO job_offer (company_id, title, description, salary_from, salary_to, currency, required_years_of_experience, required_office_days_percentage, status, created_at, updated_at)
VALUES (
